...
function AuthProvider({ children }: AuthProviderData) {
  ...
  async function signIn() {
    try {
      ...
      //essa função vai pegar o link criado informada no registro do seu app no Console da Twitch Developers: https://auth.expo.io/@fabiobala/streamData
      const REDIRECT_URI = makeRedirectUri({ useProxy: true });
      // RESPONSE_TYPE - set to "token"
      const RESPONSE_TYPE = "token";
      //os escopes estão no linkhttps://dev.twitch.tv/docs/authentication#scopes
  ...
  /* todas as rotas do twitch precisa ter cabeçalho Client-id além do token. ver no link:https://dev.twitch.tv/docs/api/reference#get-game-analytics
